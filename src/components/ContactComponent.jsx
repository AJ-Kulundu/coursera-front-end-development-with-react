...
import {Breadcrumb, BreadcrumbItem, Form, FormGroup, Label, Input, Col, CustomInput, Button, FormFeedback} from 'reactstrap';
...
class Contact extends Component {
    ...
    validate(firstname,lastname,telnum,email){
         ...
         errors.telnum = 'Tel. Number should only have numbers';
                       ...
                       <Form onSubmit={this.handleSubmit}>
                           ...
                           <FormGroup row>
                               ...
                               <Col md={{size: 3, offset:1}}>
                                   <CustomInput type="select" name="contactType"
